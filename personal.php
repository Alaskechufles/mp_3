  ...
  <main class="flex flex-col items-center justify-center">
    ...
    <div>
      ...
      <div class="w-screen md:w-[845px] md:border md:border-[#D3D3D3] rounded-xl">
        ...
        <div class="flex flex-row items-center justify-between md:justify-start px-7 py-4 border-b border-[#E0E0E0]">
        ...
        <div class="flex flex-row items-center justify-between px-7 py-7 border-b border-[#E0E0E0] md:justify-start">
